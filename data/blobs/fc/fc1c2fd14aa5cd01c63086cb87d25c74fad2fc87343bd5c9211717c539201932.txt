package com.study.ws.Servie.imp;
...
import com.study.ws.util.CoreUtil;
...
public class ChatSessionServiceImpl implements ChatSessionService {
    ...
    public void pushMessage(String fromId, String toId, String message) {
        //创建消息类，设置消息的属性fromid,toid,message,time;
        ...
        if(toId!=null){
            ...
            //公共消息 --群组
            entity.setTo(null);
            push(entity,CommonConstant.CHAT_COMMON_PREFIX);
        }
    }
    /**
     * 推送消息

...
public class BankingSystem extends JFrame {
    ...
    public BankingSystem() {
        ...
        createAccountLabel.setBounds(50, 200, 250, 30);
        createAccountButton.setBounds(120, 250, 150, 30);
    ...
    private void showMainMenu() {
        ...
        mainMenuFrame.setLayout(new GridLayout(5, 1)); // Increase grid layout rows to accommodate the new button

        JButton withdrawButton = new JButton("Withdraw Money");
        JButton checkBalanceButton = new JButton("Check Balance");
        JButton changePasswordButton = new JButton("Change Password");
        JButton depositButton = new JButton("Deposit Money");
        JButton goBackButton = new JButton("Go Back"); // Add a new button for going back
        ...
        goBackButton.addActionListener(e -> {
            mainMenuFrame.dispose(); // Dispose the main menu frame
            new BankingSystem(); // Reopen the login frame
        });
        ...
        mainMenuFrame.add(goBackButton); // Add the new "Go Back" button

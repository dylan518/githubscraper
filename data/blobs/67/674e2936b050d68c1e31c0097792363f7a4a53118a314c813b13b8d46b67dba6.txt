...
public class UserServiceImpl implements UserService{
	...
	@Autowired
	private UserRepository userRepository;//Doing property injection
	...
	public UserDto createUser(UserDto userDto) {
		...
		User savedUser = userRepository.save(user); //It needs user entity data not user dto data , so here we have to convert the data simultanously.
